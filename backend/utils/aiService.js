...
export const chatCompletion = async ({ system, user, temperature = 0.7, }) => {
    ...
    if (!c) {
        return {
            ok: false,
            content:
                "AI features are disabled. Set GEMINI_API_KEY in the backend .env file to enable real AI responses. Meanwhile, the application will continue to work with fallback responses.",
        };
    }
